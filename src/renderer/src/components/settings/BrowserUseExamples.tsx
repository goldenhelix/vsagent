...
const EXAMPLE_PROMPTS: string[] = [
  'Using VSAgent CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the VSAgent CLI and tell me what's blocked.",
  'With VSAgent CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
