          ...
          <div className="space-y-2">
            ...
            {claudeAccounts.accounts.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                No managed Claude accounts yet. VSAgent will use your system default Claude login
          ...
          {codexAccounts.accounts.length === 0 ? (
            <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
              {activeWslDistro
                ...
                : 'No managed Codex accounts yet. VSAgent will use your system default Codex login until you add one here.'}
            </div>
          ) : (
            <div className="space-y-2">
              <button
        ...
        >
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              with Google. This uses credentials issued to the Gemini CLI app, not VSAgent. May
