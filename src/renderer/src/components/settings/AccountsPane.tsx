        ...
        >
          <div className="flex items-center justify-between gap-3">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                VSAgent swaps Claude auth only; config and chat history stay in the shared Claude
                root. Showing {accountRuntime.label} accounts. New accounts are added there.
              </p>
            </div>
            <Button
              variant="outline"
          ...
          <div className="space-y-2">
            ...
            {visibleClaudeAccounts.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                No managed Claude accounts for {accountRuntime.label}. VSAgent will use that
    ...
    matchesSettingsSearch(searchQuery, ACCOUNTS_CODEX_SEARCH_ENTRIES) ? (
      <section key="codex-accounts" id="accounts-codex" className="space-y-4 scroll-mt-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            Optional. VSAgent can use your normal Codex login; add accounts only if you want quick
            switching in VSAgent.
          </p>
          <p className="text-xs text-muted-foreground">
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="space-y-0.5">
              <Label>Accounts</Label>
              <p className="text-xs text-muted-foreground">
                Add a Codex account to use it in VSAgent. Showing {accountRuntime.label} accounts.
                New accounts are added there.
              </p>
            </div>
            <Button
              variant="outline"
          ...
          <div className="space-y-2">
            ...
            {visibleCodexAccounts.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                No managed Codex accounts for {accountRuntime.label}. VSAgent will use that
        ...
        >
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              app, not VSAgent. May break if Google updates the CLI. Use at your own risk.
            </p>
          </div>
          <button
            role="switch"
