      ...
      >
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            VSAgent first refreshes the remote base, then safely fast-forwards the matching local{' '}
            <code>main</code> or <code>master</code> so those commands do not compare against stale
            history. VSAgent skips the update if the local branch is dirty or diverged.
          </p>
        </div>
        <button
          role="switch"
