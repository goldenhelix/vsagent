          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="min-w-0 space-y-1">
              <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
                ...
                Allow VSAgent in macOS
              </div>
              <p className="max-w-[58ch] text-[13px] leading-relaxed text-muted-foreground">
                Open System Settings and make sure VSAgent is allowed to send notifications.
              </p>
            </div>
            <Button
              type="button"
              ...
              <div className="flex items-center justify-between">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs leading-tight text-white/55">VSAgent</div>
                  </div>
                </div>
                <div
                  aria-hidden
      ...
      <section className="space-y-3">
        <div className="space-y-1">
          ...
          <p className="text-[13px] leading-relaxed text-muted-foreground">
            Pick the alert VSAgent plays after a desktop notification is delivered.
          </p>
        </div>
