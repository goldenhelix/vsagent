...
// can't be spawned. Shortcut labels come from useShortcutLabel(). The
// module-level navigator.userAgent isWindows from upstream is intentionally
// dropped — isWindows is resolved inside the component via shellHostIsWindows().
