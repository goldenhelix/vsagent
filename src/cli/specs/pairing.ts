...
export const PAIRING_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    notes: [
      ...
      'Use --address to advertise a specific host/IP (e.g. a Tailscale name) when the server did not set --serve-pairing-address; the embedded endpoint must be reachable from the other host.',
