...
// Why (VSAgent fork): upstream's release-cut.yml is deleted here, so the
// describe block asserting how that job calls this script is gone; the script's
// own swap/probe behavior above is what the fork still ships.
